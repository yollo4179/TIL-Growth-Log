...
<tr><td> 사용자의 로컬 컴퓨터나 모바일 장치에 저장됩니다.</td></tr>
<tr><td> 사용자 ID, 설정, 방문 기록 등 텍스트 기반의 정보가 담겨 있습니다.</td></tr>
<tr><td> 브라우저 종료 시 삭제되는 세션 쿠키, 만료일이 있는 지속적 쿠키로 나뉩니다.</td></tr>
<tr><td> 로그인 유지 , 장바구니 기억, 사용자 맞춤 설정( 언어, 테마,검색 결과) 등 , 편리한 웹 경험을 제공하고<br> 방문기록을 기반으로 추적 및 광고를 표시할 수 있습니다.</td> </tr>
</tbody>
<hr>
